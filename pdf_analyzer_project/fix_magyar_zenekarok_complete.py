#!/usr/bin/env python3
"""
Script to fix all issues in Hungarian bands questions: unique Spotify links, correct answer indices, and proper structure.
"""

import json

# Corrected Hungarian bands questions with unique Spotify links and proper correct answers
MAGYAR_ZENEKAROK_QUESTIONS = [
    ...
    },
    {
        ...
        "options": ['Parno Graszt', 'Muzsikás', 'Septic', 'Korai Öröm'],
        "correct": 0,
    ...
    },
    {
        ...
        "options": ['Palya Bea', 'Muzsikás', 'Septic', 'Korai Öröm'],
        "correct": 0,
    ...
    },
    {
        ...
        "options": ['Bohemian Betyars', 'Muzsikás', 'Septic', 'Korai Öröm'],
        "correct": 0,
    ...
    },
    {
        ...
        "options": ['Aurevoir', 'Muzsikás', 'Septic', 'Korai Öröm'],
        "correct": 0,
    ...
    },
    {
        ...
        "options": ['Dánielffy', 'Muzsikás', 'Septic', 'Korai Öröm'],
        "correct": 0,
    ...
    },
    {
        ...
        "options": ['Ham Ko Ham', 'Muzsikás', 'Septic', 'Korai Öröm'],
        "correct": 0,
...
# Write the corrected questions to the file
with open('topics/magyar_zenekarok.py', 'w', encoding='utf-8') as f:
    f.write('MAGYAR_ZENEKAROK_QUESTIONS = ')
    f.write(json.dumps(MAGYAR_ZENEKAROK_QUESTIONS, ensure_ascii=False, indent=4))
    f.write('\n\nprint(f"Magyar zenekarok kérdések száma: {len(MAGYAR_ZENEKAROK_QUESTIONS)}")\n')

print("Magyar zenekarok kérdések teljesen javítva!")
print(f"Összesen {len(MAGYAR_ZENEKAROK_QUESTIONS)} kérdés")
print("Problémák javítva:")
print("- Parno Graszt csak egyszer szerepel")
print("- Minden kérdés egyedi Spotify linket használ")
print("- Helyes opciók minden kérdésnél") 