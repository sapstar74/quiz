#!/usr/bin/env python3
"""
Script to fix Parno Graszt options issue by making answer options more varied.
"""

import json

# Corrected Hungarian bands questions with varied options
...
print("Parno Graszt opciók javítva!")
print(f"Összesen {len(MAGYAR_ZENEKAROK_QUESTIONS)} kérdés")
print("A Parno Graszt most csak egyszer szerepel, a többi opció változatosabb.") 