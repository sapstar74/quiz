#!/usr/bin/env python3
"""
Kiterjesztett magyar zenekarok keresése Spotify-on
"""
...
def search_spotify_artist_expanded(artist_name):
    """Kiterjesztett Spotify keresés több ismert magyar zenekarral"""
    ...
    known_artists = {
        ...
        "Quimby": "0YqQvRjqNXAv2K5FqS9cdO",       # placeholder
        "Kispál és a Borz": "4iJbqBq2WnU5k3IXfk6FCP",  # Ez már működik!
        "Tankcsapda": "0YqQvRjqNXAv2K5FqS9cdO",   # placeholder
        "P. Mobil": "0YqQvRjqNXAv2K5FqS9cdO",     # placeholder
        "Republic": "0YqQvRjqNXAv2K5FqS9cdO",     # placeholder
        "Bonanza Banzai": "0YqQvRjqNXAv2K5FqS9cdO", # placeholder
        "Korai Öröm": "0YqQvRjqNXAv2K5FqS9cdO",   # placeholder
        "Kispál és a Borz": "4iJbqBq2WnU5k3IXfk6FCP",  # Duplikált, de biztos
    }
...
def main():
    print("🎵 Kiterjesztett magyar zenekarok keresése...")
    ...
    for i, zenekar in enumerate(magyar_zenekarok, 1):
        ...
        link = search_spotify_artist_expanded(zenekar)
        ...
        if not link and zenekar in name_mappings:
            ...
            link = search_spotify_artist_expanded(mapped_name)
    ...
    # Eredmények mentése
    with open('magyar_zenekarok_expanded_spotify_links.json', 'w', encoding='utf-8') as f:
        json.dump(results, f, ensure_ascii=False, indent=2)
    
    # Python fájl generálása
    python_code = "# Magyar zenekarok Spotify linkjei (kiterjesztett)\n"
    python_code += "MAGYAR_ZENEKAROK_EXPANDED_SPOTIFY_LINKS = {\n"
    ...
    with open('magyar_zenekarok_expanded_spotify_links.py', 'w', encoding='utf-8') as f:
        f.write(python_code)
    
    print(f"\n📁 Eredmények mentve: magyar_zenekarok_expanded_spotify_links.json")
    print(f"✅ {success_count} valódi link találva")
    print(f"❌ {fallback_count} fallback link")
    print(f"📁 Python fájl létrehozva: magyar_zenekarok_expanded_spotify_links.py")
