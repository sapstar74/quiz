...
# Az NFL csapatok definíciója a csapatkódokkal
NFL_TEAMS = [
...
def download_nfl_logos(output_dir="nfl_logos_flat"):
    """
...
def create_nfl_teams_flat_document(logos_dir="nfl_logos_flat", output_file="nfl_teams_flat.docx"):
    """
    Word dokumentum létrehozása NFL csapatok logóival egy 8x4 táblázatban
    """
    ...
    # Rövid magyarázat
    p = doc.add_paragraph('Az alábbi dokumentum tartalmazza az NFL csapatok logóit.')
...
def main():
    ...
    logos_dir = "nfl_logos_flat"
    output_file = "nfl_teams_flat.docx"
    ...
    result = create_nfl_teams_flat_document(logos_dir, output_file)
